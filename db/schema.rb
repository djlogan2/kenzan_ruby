...
ActiveRecord::Schema.define(version: 201710261500000) do
  ...
  create_table "employee_to_roles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "employee_id"
    t.bigint "employee_role_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["employee_id"], name: "index_employee_to_roles_on_employee_id"
    t.index ["employee_role_id"], name: "index_employee_to_roles_on_employee_role_id"
  end
